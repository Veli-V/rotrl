# Sessio 02: Swallowtail Festival (1.3.2026)
...
Juhla on omistettu [[Desna]]-jumalattarelle syyspäiväntasauksen kunniaksi.
*   Legenda kertoo Desnan parantamasta enkelistä, joka muuttui perhoseksi.
*   Juhlassa esitettiin "Upea Runo", ja nähtiin taianomaisia lasisia leijonia (?).
...
## Goblin-hyökkäys
Juhlan huumassa aurinko laskee ja vuorovesi nousee. Yhtäkkiä alkaa kuulua goblin-örinää ja hyökkäys alkaa!
*   Goblinit aiheuttavat kaaosta ja ryöstävät paikkoja.
*   Ryhmä löytää goblinien jälkiä, jotka viittaavat siihen, että heillä on ollut ihmisapua (löytyy paperipallo, jossa on kirjoitusta kielellä, jota sankarit eivät heti tunnista).

## Tietoa Goblin-heimoista
Ryhmä haastattelee [[Jusk Haladan]]ia (oppinut kirjakauppias), joka kertoo alueen viidestä suurimmasta heimosta:
1.  **[[Birdcruncher]]**: Aggressiivisia lintujen syöjiä.
2.  **[[Licktoad]]**: Elävät suolla, hyviä uimareita.
3.  **[[Seven Tooth]]**: Raidkaavat kaatopaikkoja. Johtajana [[Koruvus]], jolla on taikamiekka.
4.  **[[Mosswood]]**: Suurin heimo, asuvat syvemmällä metsässä.
5.  **[[Thistletop]]**: Asuvat saarella pohjoisessa. Johtajana kuningas [[Ripnugget]].

Muita mainittuja uhkia:

...
**Päivämäärä:** 16.3.2026 (Pelinsisäinen aika: ?)
...
*   He ovat kotoisin Thistletopista, saarelta pohjoisessa, lähellä Nettlewoodin metsää.
*   Johtaja [[Ripnugget]] käski heidän hakea jotain, mutta tarkka kohde jää epäselväksi.
*   Käsky oli vain "seurata edellä kulkevaa".
...
*   Ovelta lentää kaksi asiakasta ulos juuri kun sankarit saapuvat.
*   Paikalla mainitaan nimet Rakali ja Dire Dan.
*   Huhuja liikkuu: Goblinit häiritsivät arkea, mutta eteläpäässä kaupunkia niitä ei juuri näkynyt.
*   [[Jubrayl Vhiski]] mainitaan nimeltä; häntä ei ole näkynyt hetkeen ja häneen liitetään jotain pahoja juttuja.

Isko yrittää huijata korttipelissä "Sleight of Hand" -tempulla, mutta jää kiinni. Syntyy tappelu, Isko saa turpaansa ja heitetään ulos nenä veressä.

## Draamaa Rusty Dragonissa
Illalla [[The Rusty Dragon]]issa on aluksi iloinen tunnelma. Pian kuitenkin [[Lonjiku Kaijitsu]] (Ameikon isä) ryntää sisään huutaen tyttärelleen. He riitelevät vieraalla kielellä (Minkaian).

*   Ameiko lyö isäänsä kauhalla ja käskee tätä poistumaan (Commoniksi).
...
*   Ameikon äiti kuoli vuosia sitten (huhujen mukaan putosi kallioloilta/parvekkeelta, mahdollisesti Lonjikun tönäisemänä tai onnettomuudessa).

Lopuksi ryhmä käy lepäämään majataloon.
